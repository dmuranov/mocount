...
VALUES
  ...
  ('greg.henderson@gmail.com',  'Greg Henderson',    'viewer', false, true),
  ('peter.broes@idt.net',       'Peter Broes',       'viewer', false, true),
  ('chiara.ferraro@idt.net',    'Chiara Ferraro',    'viewer', false, true)
